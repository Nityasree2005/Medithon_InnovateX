...
# Prompt template
prompt_template = """
Human: You are an AI assistant tasked with answering questions based on the information provided in PDF files. Use the following context, which contains relevant information from the PDF files, to answer the question. Follow these guidelines strictly:
...
6. Always mention the specific columns, data points, or file names from the PDF that you're using to form your answer.
7. Provide detailed, thorough responses that fully address all aspects of the question.

Context: {context}

Question: {question}
Assistant: I'll provide a comprehensive answer based on the information available in the PDF files. Here's what I found:
"""
...
def main():
    st.set_page_config(page_title="Report Chatbot", layout="wide")
    ...
    st.markdown("""
        ...
        <div class="container">
            <h1 class="title">MEDICAL REPORT CHATBOT</h1>
            <p>Upload your medical repoort and ask questions about your data!</p>
        </div>
    ...
    with st.sidebar:
        st.markdown('<div class="sidebar-title">REPORT MANAGEMENT</div>', unsafe_allow_html=True)
        ...
        if user_question:
            with st.spinner("Analyzing your data..."):
                try:
                    ...
                    st.info("Make sure you've uploaded PDF files and updated the knowledge base before asking questions.")
        else:
